...
//////////////// ************** click and set active state location sub title ********///////////
		...
		/////////************* menu item change ***************//////////		
		$("#ykko-special, #kyayoh-sichet, #chinese-cuisine, #thai-cuisine, #grills, #juice-drinks, #deserts").hide();
		//$("#new").show();
		$(document).on('click','table #new-cat', function() {
			$("#ykko-special, #kyayoh-sichet, #chinese-cuisine, #thai-cuisine, #grills, #juice-drinks, #deserts").fadeOut(800);
			$("#new").fadeIn(1500);
		});
		$(document).on('click','table #special-cat', function() { 
			$("#kyayoh-sichet, #chinese-cuisine, #thai-cuisine, #grills, #juice-drinks, #deserts, #new").fadeOut(800);
		...
		$(document).on('click','table #chinese-cat', function() { 
			$("#ykko-special, #kyayoh-sichet, #thai-cuisine, #grills, #juice-drinks, #deserts, #new").fadeOut(800);
			$("#chinese-cuisine").fadeIn(1500); 
		});
		$(document).on('click','table #thai-cat', function() { 
			$("#ykko-special, #kyayoh-sichet, #chinese-cuisine, #grills, #juice-drinks, #deserts, #new").fadeOut(800);
			$("#thai-cuisine").fadeIn(1500); 
		});
		$(document).on('click','table #grills-cat', function() { 
			$("#ykko-special, #kyayoh-sichet, #chinese-cuisine, #thai-cuisine, #juice-drinks, #deserts, #new").fadeOut(800);
			$("#grills").fadeIn(1500); 
		});
		$(document).on('click','table #juice-drink-cat', function() { 
			$("#ykko-special, #kyayoh-sichet, #chinese-cuisine, #thai-cuisine, #grills, #deserts, #new").fadeOut(800);
			$("#juice-drinks").fadeIn(1500);
		});
		$(document).on('click','table #desert-cat', function() { 
			$("#ykko-special, #kyayoh-sichet, #chinese-cuisine, #thai-cuisine, #grills, #new, #juice-drinks").fadeOut(800);
			$("#deserts").fadeIn(1500);
		});
		...
		$("#mb-special-cat").click(function(){
			$("#new,#kyayoh-sichet,#chinese-cuisine,#thai-cuisine,#grills,#juice-drinks,#deserts").fadeOut(800);
			$("#ykko-special").fadeIn(1500);
		});
		$("#mb-kyayoh-cat").click(function(){
			$("#new,#ykko-special,#chinese-cuisine,#thai-cuisine,#grills,#juice-drinks,#deserts").fadeOut(800);
			$("#kyayoh-sichet").fadeIn(1500); 
		});
		$("#mb-chinese-cat").click(function(){
			$("#new,#ykko-special,#kyayoh-sichet,#thai-cuisine,#grills,#juice-drinks,#deserts").fadeOut(800);
			$("#chinese-cuisine").fadeIn(1500); 
		});
		$("#mb-thai-cat").click(function(){
			$("#new,#ykko-special,#kyayoh-sichet,#chinese-cuisine,#grills,#juice-drinks,#deserts").fadeOut(800);
			$("#thai-cuisine").fadeIn(1500); 
		});
		$("#mb-grills-cat").click(function(){
			$("#new,#ykko-special,#kyayoh-sichet,#chinese-cuisine,#thai-cuisine,#juice-drinks,#deserts").fadeOut(800);
			$("#grills").fadeIn(1500); 
		});
		$("#mb-juice-drink-cat").click(function(){
			$("#new,#ykko-special,#kyayoh-sichet,#chinese-cuisine,#thai-cuisine,#grills,#deserts").fadeOut(800);
			$("#juice-drinks").fadeIn(1500);
		});
		$("#mb-desert-cat").click(function(){
			$("#new,#ykko-special,#kyayoh-sichet,#chinese-cuisine,#thai-cuisine,#grills,#juice-drinks").fadeOut(800);
			$("#deserts").fadeIn(1500);
		});
